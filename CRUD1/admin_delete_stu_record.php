...
// Get and validate the student ID using the GET request
if (isset($_GET["student_id"])) {
    ...
    if (preg_match($pattern, $student_id_code)) {
        // Delete the record from the `student` table that matches the student ID code pattern
        ...
        // Invalid Student ID format error message
    ...
    // Student ID not provided format error message
