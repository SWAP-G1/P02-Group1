...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Check if class codes exist in the database, but skip validation for "NULL"
    foreach ($upd_class_codes as $class_code) {
        if (!empty($class_code)) {
            ...
            // Reject the class if it does not have a "No Status" status, unless it's the currently assigned class
