...
// Initialize the error message
    ...
    if (!preg_match($pattern_student_id, $student_id_code)) {
        header("Location: admin_update_stu_recordform.php?error=" . urlencode("Invalid student ID format. It must be 3 digits followed by an uppercase letter.") . "&student_id=" . urlencode($student_id_code));
        exit();
    }
