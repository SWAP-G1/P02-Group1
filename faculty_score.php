    ...
    <div class="container">
        <div class="card">
            ...
            if (isset($_GET['success'])) {
                ...
                echo '<div id="message" style="color: green; font-weight: bold;">' . $messages[$_GET['success']] . '</div>';
            }
            if (isset($_GET['error'])) {
        ...
        <div class="card">
            ...
            echo '<tr><th>ID Code</th><th>Course</th><th>Score</th><th>Grade</th><th colspan="2">Actions</th></tr>';
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<td><a href='faculty_delete.php?operation=delete&id=" . $row['grade_id'] . "&csrf_token=" . $_SESSION['csrf_token'] . "'>Delete</a></td>";
                echo '</tr>';
            }
            echo '</table>';
            ?>
