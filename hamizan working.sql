...
--
ALTER TABLE `faculty`
  ADD UNIQUE KEY `identification_code_2` (`identification_code`,`email`,`full_name`,`class_code`),
...
ALTER TABLE `class`
  ...
  ADD CONSTRAINT `fk_faculty` FOREIGN KEY (`faculty_identification_code`) REFERENCES `user` (`identification_code`);
...
--
ALTER TABLE `faculty`
  ADD CONSTRAINT `faculty_ibfk_1` FOREIGN KEY (`identification_code`) REFERENCES `user` (`identification_code`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `faculty_ibfk_2` FOREIGN KEY (`email`) REFERENCES `user` (`email`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `faculty_ibfk_3` FOREIGN KEY (`full_name`) REFERENCES `user` (`full_name`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `faculty_ibfk_4` FOREIGN KEY (`class_code`) REFERENCES `class` (`class_code`) ON DELETE CASCADE ON UPDATE CASCADE;
