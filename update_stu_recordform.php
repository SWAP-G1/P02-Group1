...
<body>
    <div class="navbar">
        ...
        <nav>
            <a href="create_stu_recordform.php">Back to Student Records</a>
    ...
    <div class="container">
        <div class="card">
            ...
            <?php else: ?>
                <form method="POST" action="update_stu_record.php?student_id=<?php echo htmlspecialchars($student_id); ?>">
